...
int main()
{
    ...
    int location_option;
    cout << "Please choose your preferred location:" << endl;
   ...
   default:
    ...
    cout << "Hello" << ", " << student_name << " your total bill is: NGN " << total << endl;
...
float discount2;
    ...
    if (PAU_student && (location_option== 2 || location_option == 3)){
       ...
       cout<<"Your 5% discounted price is: NGN "<< discount1<<endl;
    }
      
     
        if ((days_for_course >5) || (regfee > 12000)){
            discount2 =(0.03) * total;
            cout<<"Your 3% discounted price is: NGN "<< discount2;
        }
         int promo;
          srand(time(0));
